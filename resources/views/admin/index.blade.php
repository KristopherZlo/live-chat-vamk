...
<x-app-layout page-class="page-admin admin-shell">
            ...
            <div class="admin-sections">
                            ...
                            <div class="admin-card">
                                ...
                                <div class="admin-health">
                                    <div class="admin-health__row">
                                        <span>Database</span>
                                        <span class="admin-chip admin-chip--success">OK</span>
                                    </div>
                                    <div class="admin-health__row">
                                        <span>Queue</span>
                                        <span class="admin-chip admin-chip--success">OK</span>
                                    ...
                                    <div class="admin-health__row">
                                        <span>Realtime</span>
                                        <span class="admin-chip admin-chip--success">Configured</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section class="admin-section" data-section="sessions">
                    <div class="admin-grid">
                        ...
                        <div class="admin-card">
                            ...
                            <p class="admin-muted">Impersonation & forced logout tools are not wired yet. Use database or session management manually if needed.</p>
                            <div class="admin-card__footer">
                                <button class="admin-btn admin-btn--ghost" type="button" disabled>Planned</button>
                            </div>
                        </div>
                    </div>
                </section>
                                        ...
                                        @forelse($rooms as $room)
                                            <tr>
                                                ...
                                                <td class="text-right admin-actions">
                                                    ...
                                                    <a class="admin-btn admin-btn--ghost" href="{{ route('rooms.questionsPanel', $room) }}" target="_blank">Questions</a>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
                ...
                <section class="admin-section" data-section="logs">
                    <div class="admin-card">
                        ...
                        <p class="admin-muted">Server logs live in <span class="admin-mono">storage/logs/laravel.log</span>. For production, forward logs to your platform or tail locally.</p>
                    </div>
                </section>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const roomTabs = document.querySelectorAll('[data-rooms-tab]');
            const roomViews = document.querySelectorAll('[data-rooms-view]');
            ...
            const setRoomsView = (view) => {
                roomTabs.forEach((tab) => tab.classList.toggle('is-active', tab.dataset.roomsTab === view));
                roomViews.forEach((panel) => panel.classList.toggle('rooms-view--hidden', panel.dataset.roomsView !== view));
            };

            roomTabs.forEach((tab) => {
                tab.addEventListener('click', () => setRoomsView(tab.dataset.roomsTab || 'all'));
            });
